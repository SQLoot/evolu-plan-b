...
Added `StructuralMap`, a `Map`-like collection for registries and coordination tables where callers naturally already have immutable JSON-like keys or `Uint8Array` keys and do not want to maintain a separate string id.
