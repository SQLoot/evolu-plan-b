[API Reference](/docs/api-reference/page.mdx) / [@evolu/common](/docs/api-reference/common/page.mdx) / [Type](/docs/api-reference/common/Type/page.mdx) / InstanceOfType

Defined in: [packages/common/src/Type.ts:867](https://github.com/SQLoot/EvoLoot/blob/d86280a21ced8e9f86b70217b1c345b37bea4ce2/packages/common/src/Type.ts#L867)
...
- [`Type`](/docs/api-reference/common/Type/interfaces/Type.mdx)\<`"InstanceOf"`, `InstanceType`\<`T`\>, `InstanceType`\<`T`\>, [`InstanceOfError`](/docs/api-reference/common/Type/interfaces/InstanceOfError.mdx)\>
...
```ts
readonly ~standard: Props<InstanceType<T>, InstanceType<T>>;
```
...
Defined in: [packages/common/src/Type.ts:874](https://github.com/SQLoot/EvoLoot/blob/d86280a21ced8e9f86b70217b1c345b37bea4ce2/packages/common/src/Type.ts#L874)
...
```ts
readonly Errors: InstanceOfError;
```
...
```ts
readonly from: (value: InstanceType) => Result<InstanceType<T>, InstanceOfError>;
```
...
[`Result`](/docs/api-reference/common/Result/type-aliases/Result.mdx)\<`InstanceType`\<`T`\>, [`InstanceOfError`](/docs/api-reference/common/Type/interfaces/InstanceOfError.mdx)\>
...
```ts
readonly fromParent: (value: InstanceType) => Result<InstanceType<T>, InstanceOfError>;
```
...
```ts
readonly fromUnknown: (value: unknown) => Result<InstanceType<T>, InstanceOfError>;
```
...
```ts
readonly is: Refinement<unknown, InstanceType<T>>;
```
...
```ts
readonly orNull: (value: InstanceType) => InstanceType<T> | null;
```
...
```ts
readonly orThrow: (value: InstanceType) => InstanceType;
```
