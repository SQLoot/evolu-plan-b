[API Reference](/docs/api-reference/page.mdx) / [@evolu/common](/docs/api-reference/common/page.mdx) / [Type](/docs/api-reference/common/Type/page.mdx) / RecursiveType

Defined in: [packages/common/src/Type.ts:3805](https://github.com/SQLoot/EvoLoot/blob/d86280a21ced8e9f86b70217b1c345b37bea4ce2/packages/common/src/Type.ts#L3805)
...
Defined in: [packages/common/src/Type.ts:3814](https://github.com/SQLoot/EvoLoot/blob/d86280a21ced8e9f86b70217b1c345b37bea4ce2/packages/common/src/Type.ts#L3814)
...
```ts
readonly ~standard: Props<InferInput<ParentType>, InferType<ParentType>>;
```
...
```ts
readonly from: (value: InferInput) => Result<InferType<ParentType>, 
  | InferError<ParentType>
| InferParentError<ParentType>>;
```
...
[`Result`](/docs/api-reference/common/Result/type-aliases/Result.mdx)\<[`InferType`](/docs/api-reference/common/Type/type-aliases/InferType.mdx)\<`ParentType`\>, 
  \| [`InferError`](/docs/api-reference/common/Type/type-aliases/InferError.mdx)\<`ParentType`\>
  \| [`InferParentError`](/docs/api-reference/common/Type/type-aliases/InferParentError.mdx)\<`ParentType`\>\>
...
```ts
readonly fromParent: (value: InferParent) => Result<InferType<ParentType>, InferError<ParentType>>;
```
...
| Parameter | Type |
| ------ | ------ |
| `value` | [`InferParent`](/docs/api-reference/common/Type/type-aliases/InferParent.mdx) |

#### Returns

[`Result`](/docs/api-reference/common/Result/type-aliases/Result.mdx)\<[`InferType`](/docs/api-reference/common/Type/type-aliases/InferType.mdx)\<`ParentType`\>, [`InferError`](/docs/api-reference/common/Type/type-aliases/InferError.mdx)\<`ParentType`\>\>
...
```ts
readonly fromUnknown: (value: unknown) => Result<InferType<ParentType>, 
  | InferError<ParentType>
| InferParentError<ParentType>>;
```
...
```ts
readonly is: Refinement<unknown, InferType<ParentType>>;
```
...
#### Returns
  ...
  \| [`InferType`](/docs/api-reference/common/Type/type-aliases/InferType.mdx)\<`ParentType`\>
  \| `null`
...
[`InferType`](/docs/api-reference/common/Type/type-aliases/InferType.mdx)
...
```ts
ParentError: InferParentError<ParentType>;
```
